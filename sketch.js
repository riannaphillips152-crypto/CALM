...
function setup() {
  ...
  if (!meditationSlider) {
      console.error("Meditation slider not found! Make sure 'meditationSlider' ID exists in calm.html.");
  }
  meditationSlider.value = 0; // Default to most still
...
function draw() {
  if (calmInstance) {
    ...
    console.error("calmInstance is null in draw()! Check setup().");
  }
}
